...
fun hotel(){
    val html = buildString {
        ...
        append(BodyClose())
        append(HtmlInline(styles = Style(CSS.FONT_FAMILY to "Arial, sans-serif", CSS.COLOR to "#333"), contents = " ")) // Apply global styles
    }
...
fun article(){
    val page = buildString{
        ...
        val fourthSection = PInline("Quantum Entanglement and Quantum Tunnelling:",articleSubSectionsStyle).nl()
        val fifthSection = PInline("The Path Ahead - Ongoing Research and Speculation:",articleSubSectionsStyle).nl()
        ...
        val blogTitle = DivInline(H2Inline("The Quest for Faster-Than-Light Travel: Breaking the Cosmic Speed Limit").nl(),articleTitleStyle).nl()
        ...
        val article = ArticleInline(
            ...
            Style(
                CSS.BACKGROUND_COLOR to transparentBlack70,
                CSS.MAX_WIDTH to "1050px",
                CSS.MARGIN to "0 auto",
                CSS.BORDER_RADIUS to "10px",
                CSS.BORDER to "1px solid $white",
